...
<div class="container">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <h2 class="text-center text-dark mt-5">FORMULAIRE DE CONNEXION DES VENDEURS</h2>
            <div class="text-center mb-5 text-dark">Se connecter en tant que vendeur</div>
            <div class="card my-5">
                ...
                @endif
                <form class="card-body cardbody-color p-lg-5" action="{{route('HandleVendorsLogin')}}" method="POST">
                    @method('post')
                    @csrf
